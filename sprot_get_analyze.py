...
#==============================
    ...
    #
    print '===================================================================='
    print ' sprot_get_analyze.py, v1.01, written by Phil Wilmarth, OHSU, 2009.'
    print '===================================================================='
    #
    ...
    (name_freq, name_to_id, prot_count) = \
                fasta_lib.uniprot_species_frequency(os.path.join(folder, fname))
    #
    # sort the species names and write to file
    #
    fasta_lib.save_species_info(db, folder, name_freq, \
                                name_to_taxon, sci_to_taxon, id_to_taxon, \
